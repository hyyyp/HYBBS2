...
(function(){
    ...
    UM.registerWidget( widgetName,{
        ...
        createPreviewVideo: function(url){
            ...
            var tmpUrl = conUrl.substr(0,conUrl.indexOf('?'));

            if(me.endWith(tmpUrl,[".swf"])){ //Flash  embed
                ...
                $("#eduiVideoPreview", me.$widget)[0].innerHTML = '<video controls="controls"' +
                ' src="' + url + '"' +
                ' width="' + 420  + '"' +
                ' height="' + 280  + '"' +
            ...
            console.log('百度mini编辑器 FLASH URL :'+ me.endWith(tmpUrl,[".swf",".flv",".wmv"]));
